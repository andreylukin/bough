...
Found by the phase's own screen-level SWAP gate (`scripts/tui/31-codemode-swap.sh`), and it is the
...
Gates: `scripts/tui/31-codemode-swap.sh` is GREEN in full (8 ok, `typed_rows_again_after_revert`
