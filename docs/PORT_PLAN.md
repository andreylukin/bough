# Port plan (dependency-ordered waves) — COMPLETED, kept as history

The port this plan describes is done: the TypeScript tree it ports FROM has been
deleted and the Rust tree is the system. Nothing here is a to-do list. It is kept
