...
#
# Env: MODEL (default openrouter/openai/gpt-5.6-luna), TIMEOUT (agent seconds, default 2400),
#      CONC (default 4), CONFIG (an arm: a bough.yml to use instead of the adapter's default).
set -euo pipefail
...
CONC=${CONC:-4}
BIN=$ROOT/bench/harbor/dist/bough-go-linux-amd64
