<!-- Generated from @openuidev/browser-bundle 0.1.1: window.__OpenUI.openuiChatLibrary.prompt({}) with the
     chat-assistant framing removed (the model writes this language as the code argument of tools.artifact,
     not as its whole reply). Regenerate when the bundle in lib/ is updated. -->
## Syntax Rules
...
- Only real data: what you measured, read or were told. Never invent numbers to fill a chart.
