...
export function Controls({ row, projects, onModel, onEffort, onAssign, only, disabled = false }: {
          ...
          <div className="head-more" ref={moreRef}>
            ...
            {more && (
              <div className="head-pop" role="dialog" aria-label="Session settings" id={"more-" + row.id} tabIndex={-1} onKeyDown={(e) => {
                ...
                <div className="head-pop-run"><Controls row={row} projects={projects} onModel={onModel} onEffort={onEffort} onAssign={onAssign} only="model" disabled={failedLoad} /></div>
        ...
        <div className="composer composer-multi"
          ...
          <div className="composer-bar">
            <div className="composer-tools">
              ...
              <Controls row={row} projects={projects} onModel={onModel} onEffort={onEffort} onAssign={onAssign} only="model" disabled={failedLoad} />
