...
function saveTranscripts(serve: Serve, spec: string, ids: string[], title: string): void {
  ...
  // Capped: an exhaustive walk's title (MODEL_COVER=transitions) runs to
  // hundreds of steps, past the 255-byte file name limit. "path-<i>" at
  // its head and the session id keep the name unique.
