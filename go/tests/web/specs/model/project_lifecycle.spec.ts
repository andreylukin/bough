...
modelTests<Ctx>({
  ...
  pollStepMs: 0,
  // The spec walks refusals on purpose (a 409 create, a 400 broken
  // project.yml) and the page shows them; a 5xx or anything the page
  // itself logs still fails the walk.
  allowConsole: /^Failed to load resource: the server responded with a status of 4\d\d /,
