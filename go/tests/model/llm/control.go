...
type Turn struct {
	...
	// Items, on a release, are the response's output as given, before
	// its Calls, with nothing streamed: what Stream and Think already
	// sent is what the response records.
