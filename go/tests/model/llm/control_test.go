...
// A taken turn leaves the request it answered as <name>.req, so a test
// can tell what reached the model: a notice that lands inside a running
// turn has no history entry of its own at the moment it is sent.
