...
// Each request the row answers leaves <name>.request with the tool
// results it carried, so a test can check what the model was told about
// a call (a hook's refusal, say) on the request that read it.
